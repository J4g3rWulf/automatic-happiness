...
> Os scripts de **treinamento, avaliação e conversão do modelo de IA** utilizado neste app estão em um repositório separado: 👉 [Repositório da Rede Neural](URL_DO_REPOSITORIO_DA_REDE_NEURAL)
